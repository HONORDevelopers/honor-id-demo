...
public class GetInfoDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String getInfoUrl = "https://account-drcn.platform.hihonorcloud.com/rest.php?nsp_fmt=JSON&nsp_svc=GOpen.User.getInfo";
        ...
        String accessToken = "CgB6e3x9LNBGr/LuJ77I3ijp/3JA2gMM+sy5Z+R8rUUKou+JtZU6ZYVP4t6wjep8QnOgoEyL0eFj756WmWakI";
