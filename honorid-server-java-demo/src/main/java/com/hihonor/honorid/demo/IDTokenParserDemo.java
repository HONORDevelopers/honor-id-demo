...
public class IDTokenParserDemo {
    ...
    private final static String CERT_URL = "https://hnoauth-login.cloud.hihonor.com/oauth2/v3/certs";
    ...
    /**
     * get jwks from the https://hnoauth-login.cloud.hihonor.com/oauth2/v3/certs endpoint
